    ...
    commands = {
        ...
        setup = {
            ...
            action = function(_options, command, args, cli)
                ...
                if _noOptions or _options.app then
                    am.execute_extension("__bitg/download-binaries.lua", { contextFailExitCode = EXIT_SETUP_ERROR })
                end
        ...
        validate = {
            ...
            action = function(_options, command, args, cli)
                ...
                -- //TODO: add switches
                ami_assert(proc.EPROC, "BITG node AMI requires extra api - eli.proc.extra", EXIT_MISSING_API)
                ami_assert(fs.EFS, "BITG node AMI requires extra api - eli.fs.extra", EXIT_MISSING_API)
                ...
                log_success("BITG node configuration validated.")
            end
        },
        about = {
